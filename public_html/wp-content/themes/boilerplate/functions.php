...
add_image_size( "news_thumb", 215, 215);

include(TEMPLATEPATH.'/lj-functions/includes.php');
...
$ajax_array = array("show_more_posts");
foreach($ajax_array as $item){
...
function show_more_posts(){
	...
	$q_s = $_REQUEST["query_string"];

	if($offset){
	 $offset = "&offset=".$offset;
	}
	echo "<div>";
		query_posts($q_s.$offset);
		while(have_posts()):the_post();
		//query_posts($q_s.'&post_type=post&post_status=publish&showposts='.$showposts.$offset);
