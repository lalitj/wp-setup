...
function register_sml_menu() {
	add_menu_page('Subscribers', 'Subscribers', 'edit_posts', dirname(__FILE__).'/index.php', '',   plugins_url('sml-admin-icon.png', __FILE__), 58.122);
}
...
function smlsubform($atts=array()){
	...
	$return = '<div class="email-form"><h3>JOIN OUR EMAIL LIST</h3>';
	...
	$return .= '<input type="text" name="sml_name" placeholder="Name" class="required"/><br/>
				<input type="email" name="sml_email" placeholder="Email Address" class="required email"/><br/>
	...
	/*if ($showname) 
		$return .= '<p class="sml_name"><label class="sml_namelabel" for="sml_name">'.$nametxt.'</label><input class="sml_nameinput" placeholder="'.$nameholder.'" name="sml_name" type="text" value=""></p>';
